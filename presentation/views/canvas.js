...
import {canvasOffsetX,canvasOffsetY,canvasWidth,canvasHeight} from "../../constants.js";
...
#zoomBar::-webkit-slider-runnable-track {
   background-color: darkgray;
   height: 40%;  
}

/* slider track for FireFox*/
#zoomBar::-moz-range-track {
   background-color: darkgray;
   height: 40%;
}
...
export class canvas extends abstractView{
    ...
    connectedCallback() {
        ...
        // can only modify style once connected
    ...
    move(){
        ...
        const deltaTime = (currentTime-this.previousTime)/10
